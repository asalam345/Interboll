    ...
    Plugin.prototype.init = function () {
		...
		if(this.autoHeight > this.options.lHeight){
			$(el)
				...
				.append('<div class="lm-control"><a href="javascript:void(0)" class="glyphicon glyphicon-menu-down2"></a></div>');
		...
		$(el).find('.lm-control a').click(function(){
			...
			if($(this).hasClass('lmcontract')){ //do less
				$(this)
					...
					.removeClass('glyphicon-menu-up2')
					.addClass('glyphicon-menu-down2');				
				$(el)
				...
				$(this)
					.addClass('lmcontract')
					.removeClass('glyphicon-menu-down2')
					.addClass('glyphicon-menu-up2');

...
public partial class admin_Manage_Privacy : System.Web.UI.Page
{
    ...
    private void BindGridviewData()
    {
        ...
        DataSet ds = ClPost.List_of_Help_Items_Privecy();
    ...
    protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("delete from tbl_Add_Item_Privacy where P_Id=" + Id, con);

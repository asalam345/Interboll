...
public partial class admin_Add_Item_Help : System.Web.UI.Page
{
    string filename;
    string filename1;
    String path;
    ...
    private void SaveArticle()
    {
        ...
        if (!string.IsNullOrEmpty(hidArticleId.Value))
        {
            ...
            ClPost.Update_tbl_Add_Help(hidArticleId.Value, Category_Id, P_Name, P_Description, Image_Name, C_Name, P_Url, P_Status, P_Sl, Post_Date, Segment);
        }
        else
        {
            // add as a new article
            string articleId = ClPost.Insert_tbl_Add_Item_Help(Category_Id, P_Name, P_Description, Image_Name, C_Name, P_Url, P_Status, P_Sl, Post_Date, Segment);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Manage_Help.aspx");
    }
    ...
    {
        DataSet ds = ClPost.Get_Item_Id_Wise_Help(P_Id);

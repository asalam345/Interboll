...
DateTime Post_Date;
    ...
    private void SaveArticle()
    {
      ...
      Category_Id = Convert.ToByte(ddlType.SelectedItem.Value);    
        ...
        if (!string.IsNullOrEmpty(hidArticleId.Value))
        {
            ...
            ClPost.Update_tbl_Add_Item(hidArticleId.Value, Category_Id, P_Name, P_Description, Image_Name, C_Name, P_Url, P_Status, P_Sl, Post_Date, Segment);
        }
        else
        {
            // add as a new article
            string articleId = ClPost.Insert_tbl_Add_Item(Category_Id, P_Name, P_Description, Image_Name, C_Name, P_Url, P_Status, P_Sl, Post_Date, Segment);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Manage_Item.aspx");
    }
    ...
    {
        DataSet ds = ClPost.Get_Item_Id_Wise(P_Id);

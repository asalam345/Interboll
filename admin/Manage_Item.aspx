<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Manage_Item.aspx.cs" Inherits="admin_Manage_Item" %>
...
<div class="col-lg-12">
            <a href="Add_Items.aspx" class="btn btn-info">Add New </a>
            </div>
...
<HeaderStyle BackColor="#df5015" />
   ...
   <asp:TemplateField HeaderText="Edit Info" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="centerAlign">
									<ItemTemplate>
									 <a id="lnkDistribute" class="btn btn-primary" href="Add_Items.aspx?P_Id=+<%#Eval("P_Id") %>+ &TB_iframe=true&height=600&width=800">
											Edit</a>
									</ItemTemplate>
								</asp:TemplateField>

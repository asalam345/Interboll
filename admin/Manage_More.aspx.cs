...
public partial class admin_Manage_More : System.Web.UI.Page
{
    ...
    private void BindGridviewData()
    {
        ...
        DataSet ds = ClPost.List_of_Items_More();
    ...
    protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("delete from tbl_Item_More where P_Id=" + Id, con);
    ...
    private void BindGridviewData1()
    {
        ...
        DataSet ds = ClPost.List_of_More_Product_Wise(categoryid);
        gvDetails.DataSource = ds;
        gvDetails.DataBind();
        con.Close();
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Sports.aspx.cs" Inherits="Sports" %>
 ...
 Sports
      ...
      <!--music step slider start-->
                                  <div class="boxproetabevent2">
                                    <div class="eventstitle">Like Sports</div>
											      ...
											      <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/md5.jpg"></a>
                                                           <h5><a href="#">Saved The Best</a></h5>
                                                            <p class="fonteventtext">Miles1 <br>
											      ...
											      <div class="col-sm-3">
                                                   ...
                                                   <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/md8.jpg"></a>
                                                           <h5><a href="#">Shapla Salique </a></h5>
                                                            <p class="fonteventtext">Achen Kothay lok <br>
                            ...
                            <%--        <div class="eventstitle">Listen Later</div>--%>
                	                   ...
                	                   <div class="row gutter-10">
											      ...
											      <div class="col-sm-3">
                                                   ...
                                                   <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/sp2.jpg"></a>
                                                           <h5><a href="#">Arafat Mohsin </a></h5>
                                                            <p class="fonteventtext">Boka Chad<br>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/sp3.jpg"></a>
                                                           <h5><a href="#">Pritom feat</a></h5>
                                                            <p class="fonteventtext">Akash Bhora Josna <br>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/sp4.jpg"></a>
                                                           <h5><a href="#">Shapla Salique </a></h5>
                                                            <p class="fonteventtext">Achen Kothay <br>
                                      ...
                                      <div class="boxproe2">
                                       ...
                                       <div class="eventstitle">Pop Music</div>
                                  	    <div class="row gutter-10">
							                         ...
							                         <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/sp6.jpg"></a>
                                                   ...
                                                   <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/sp5.jpg"></a>

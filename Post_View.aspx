<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Post_View.aspx.cs" Inherits="Post_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <div class="boxsocial2">
			   ...
			   <div class="boxpro"  style="display:none">
    ...
    height: 115px;">
                       ...
                       <asp:Label ID="Label1" runat="server" Text="" Visible="false"></asp:Label>
						    <div class="checkbox" id="my_control2" style="display:none" runat="server">
                              ...
                              <div class="inputmapse">  <asp:TextBox ID="my_control"  runat="server" Visible="true" style="width:103%; padding-left:5px; height:24px" placeholder="Location Search..."></asp:TextBox>
    ...
    <asp:FileUpload ID="file_upload" runat="server" onchange="previewFile()" >
                                    ...
                                    <!--check end-->
                                     ...
                                     <div class="leftimag">  
                                           <div class="dropdown">
					                                        <div data-toggle="dropdown" type="button" class="dropdown-toggle" aria-expanded="true">
					                                               <button class="btn-primary postbtn"  title="Follower/Only Me"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"></i>
                                                                   </button>
					                                        </div>
					                                          <ul class="dropdown-menu postinfotagpeople">
					                                             <li>
                                     ...
                                     <div class="leftimag">   <button type="submit" runat="server" id="btnLogin" class="btn-primary postbtn" >
					                              Post
					                           </button></div>
                       ...
                       <asp:Repeater ID="rptPost" runat="server" OnItemDataBound="RepeaterItemCreated" OnItemCommand="itemRepeater_ItemCreated">
                        ...
                        <div class="boxpro">
							  ...
							  <%--   <a href="#"> <img border="0" align="left" class="imgprofilenotifi2" src="img/img3.png"></a>--%>
                                ...
                                <a href="<%# "frndpage.aspx?ID=" +blog.Encrypt(Eval("A_User_Id").ToString()) %>"> <asp:Image ID="Image2" runat="server"  CssClass="imgprofilenotifidefault2" ImageUrl='<%# Bind("Profile_Image",  "~/{0}") %>'/></a>
                                <a href="<%# "frndpage.aspx?ID=" +blog.Encrypt(Eval("A_User_Id").ToString()) %>"><asp:Label ID="Label2" runat="server" Text='<%# Eval("First_Name") %>' Width=" "></asp:Label> 
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("F_Image") %>' Width=" "></asp:Label>  </a>,
                                   <br>
							      <span style="font-size:12px">     <%# string.Format("{0:dddd, MMMM d, yyyy}", Eval("P_Date"))%></span> at <span style="font-size:11px">     <%# Eval("StartTime")%></span>
                                             ...
                                             <div class="locationname" id="divchek" runat="server"><i class="glyphicon glyphicon-map-marker"></i> <span>  <asp:Label ID="lblcheking" runat="server" Text='<%# Bind("checking") %>' Width=" " Visible=""></asp:Label>  </span></div>
        ...
        <asp:Label ID="lblP_Image" runat="server" Text='<%# Bind("P_Image") %>' Width=" " Visible="false"></asp:Label>
							   ...
							   <div class="col-sm-3 col-xs-4 text-right">
                                  <div class="lefttag">  <a href="#" data-toggle="dropdown" type="button" class="dropdown-toggle"  title="Liked"><i class="glyphicon glyphicon-hand-right"></i>  <asp:Label ID="Label1" runat="server" Text='<%# Eval("Like1") %>' Width=" "></asp:Label> </a> 
                                  ...
                                  <div class="lefttag"> <a href="#" data-toggle="dropdown" type="button" class="dropdown-toggle"  title="Share"><i class=" glyphicon glyphicon-share"></i>  <asp:Label ID="Label4" runat="server" Text='<%# Eval("share1") %>' Width=" "></asp:Label></a> 
                                  ...
                                  <asp:Repeater ID="rpttagpeople" runat="server" Visible="false" >
                                        <ItemTemplate>
										   <li>
                                                ...
                                                <div class="col-sm-10 col-xs-9">
                                                    <a href="<%# "frndpage.aspx?ID=" +blog.Encrypt(Eval("Tagid").ToString()) %>"><asp:Label ID="Label2" runat="server" Text='<%# Eval("Tagname") %>' Width=" "></asp:Label></a>                   
                                                 </div>
                                          </li>  
	 ...
	 <div class="" style="margin-top:10px;">
        ...
        <div style="text-align:center"> <asp:Image ID="Image1" runat="server"  height=""  Width="100%" CssClass="imresponsive"  Visible="false"  ImageUrl='<%# Bind("Post_Image", "~/images/Items/{0}") %>'/></div>
               ...
               <div style="clear:both"></div>
                  ...
                  <div class="dolessmore" style="margin-top:8px"> <p><asp:Label ID="Label3" runat="server" Text='<%# Bind("P_Description") %>'></asp:Label></p>
                        	<div style="clear:both"></div>
                  </div>	
       ...
       Comment     </div>
               <div class="commentscount" style="margin-left:2px"><asp:Label ID="lblcommentname" runat="server" Text='<%# Bind("Comment1") %>' Width="" ></asp:Label></div>
           
                                                   <div class="commentsleft" style="display:none">
                                                      <asp:Button ID="Button2" runat="server" Text="Comment"  CommandName="lokin" AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>' cssclass="postbtn2"/></div>
                                           <div style="clear:both"></div>    
                                        ...
                                        <div class="leftimag2"> <button class="postbtn2" title="Save">Save </button></div>
                                        <div class="leftimag2"><button class="postbtn2" title="Hide">Hide</button></div>
                                        <div class="leftimag2"><asp:Button ID="Button1" runat="server" Text="Edit" OnClick="btnReplyClicked1" Visible="false" AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>' cssclass="postbtn"/></div>
                                        <div class="leftimag2"> <asp:Button ID="deleteButton" runat="server" Text="Delete"   Visible="false" AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>' CssClass="postbtn" OnClientClick="return confirm('Are you sure you want to delete this Information?');" /></div>
                                                       ...
                                                       <div style="float:left; margin-right:10px">  <a href="<%# "frndpage.aspx?ID=" +blog.Encrypt(Eval("IID").ToString()) %>">
                                                        ...
                                                        <asp:Label ID="lblcommentname" runat="server" Text='<%# Bind("P_Comment") %>' Width=""></asp:Label>
                                                                <asp:Label ID="lblpcomtid_Pid" runat="server" Text='<%# Bind("P_Id") %>' Width="" Visible="false"></asp:Label>
                                                                   ...
                                                                   <div class="leftimag2" style="float:right"> <asp:Button ID="deleteButtoncomment" runat="server" Text="Delete"  OnClick="btnCommentDelete" Visible="false" AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>' CssClass="glyphicon glyphicon-hand-right" OnClientClick="return confirm('Are you sure you want to delete this Information?');" style="background-color:#ffffff!important;color:#000; border:0px"/>
                                                                       <div id="deleteButtoncomment12" runat="server" > <button ID="deleteButtoncomment2" style="background-color:#ffffff!important;color:#000; border:0px!important" onserverclick="btnCommentDelete"  AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>'><i class="glyphicon glyphicon-trash"></i></button> </div>
                                                                   </div>

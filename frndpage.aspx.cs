...
public partial class frndpage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                FrnId = Convert.ToInt32(blog.Decrypt(Request.QueryString["ID"]).ToString());
    ...
    private void loadPost()
    {
        ...
        FrnId = Convert.ToInt32(blog.Decrypt(Request.QueryString["ID"]).ToString());
        DataSet ds = ClPost.List_of_Post_Friends(Convert.ToString(FrnId), countryid);

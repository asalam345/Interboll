...
public partial class hepl : System.Web.UI.Page
{
    ...
    {
       con.Open();
        DataSet ds = ClPost.Get_Item_Id_Wise_Help("1");
...
private void load_Post_2()
    {
       con.Open();
        DataSet ds = ClPost.Get_Item_Id_Wise_Help("2");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("3");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("4");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("5");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("6");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("7");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("8");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("9");
...
{
    con.Open();
    DataSet ds = ClPost.Get_Item_Id_Wise_Help("10");

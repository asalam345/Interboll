<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="eventdetails1.aspx.cs" Inherits="eventdetails1" %>
                  ...
                  <div class="boxsocial2">
		                 <div class="boxproe">
                                ...
                                <div class="calenderevents">
                                    ...
                                    <div style="float:left"> <asp:Label ID="lblEventName" runat="server" Text=""></asp:Label> </div>
                                    <div style="clear:both"></div>
                                </div>

...
/// <summary>
/// Summary description for CryptoXor
/// </summary>
public static class CryptoXor
{
    //private static string _b64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijk.mnopqrstuvwxyz-123456789+/=";
    private static string _b64 = "abcdefghijklmnopqrstuvwxyz0123456789"; // 36
    private static string defaultKey = "kuj2yrdfqcdqwr54rec";
    ...
    public static string Encode(string data, string key)
    {
        ...
        for (int i = 0; i < binarydata.Length; i += 4)
        {
            ...
            cipher += GetB64FromN(v * 2 + m);  //cipher += GetB64FromN(v * 4 + m);
            if (++m > 5) //if (++m > 3)
                m = 0;
        }
        return cipher;
    ...
    public static string Decode(string data, string key)
    {
        ...
        foreach (char c in data)
        {
            int v = (GetNFromB64(c) - m) / 2;  //int v = (GetNFromB64(c) - m) / 4;

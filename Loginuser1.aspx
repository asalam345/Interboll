<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Loginuser1.aspx.cs" Inherits="Loginuser1" %>
      ...
      <script type="text/javascript">
          ...
          <body>
			...
			<div style="margin:0 auto; text-align:center; min-height:80px; margin-top:10px">
			   <a href="#"><img src="logo.png" border="0px"></a>
			</div>
            ...
            <div class="logmod__container">
              <ul class="logmod__tabs">
                 <li data-tabtar="lgm-1" id="signup"><a href="#">Sign Up</a></li>
                  <li data-tabtar="lgm-2" id="signid"><a href="#">Login</a></li>

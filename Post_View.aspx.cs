...
public partial class Post_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string PostId1 = (Request.QueryString["ID"]);
            ...
            if (Product == 5)
            {
                Response.Redirect("eventdetails1.aspx?ID1=" + PostId1 + "&ID=" + PostId1);
            }
    ...
    protected void Update_Notification()
    {
        ...
        ClPost.Update_Notification_Status(Nappies_Id, Product);
    ...
    private void loadPost()
    {
        ...
        DataSet ds = ClPost.List_of_Post_Id_Wise(PostId, countryid);

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="outlinedefault.aspx.cs" Inherits="outlinedefault" %>
    ...
    <embed src='<%#DataBinder.Eval(Container.DataItem, "E_Video") %>' type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="480" height="385">
                                        ...
                                        <div class="photouploadstatus">
                                         ...
                                         <asp:Label ID="lblLike111" runat="server" Text=""></asp:Label>--%>
                                                            ...
                                                            <div id="divEdited" runat="server" class="leftimag2" style="margin-top: 2px">
                                                            ...
                                                            <div class="leftimag2">
                                                                <asp:Button ID="deleteButton" runat="server" Text="Delete" Visible="false" AutoPostBack="True" CommandArgument='<%#Eval("P_Id")%>' CssClass="postbtn" OnClientClick="return confirm('Are you sure you want to delete this Information?');" />
                                                            </div>
        ...
        function ToggleDisplay(id) {
            ...
            if (elem) {
                if (elem.style.display != 'block') {
                    ...
                    elem.style.visibilitdeleteButtoncomment12y = 'hidden';
                }
            }
        }
    </script>

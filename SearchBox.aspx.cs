...
public partial class SearchBox : System.Web.UI.Page
{
    ...
    protected void RepeaterItemCreated(object sender, RepeaterItemEventArgs e)
    {
        foreach (RepeaterItem ri in rptFriend.Items)
        {
            ...
            if (ds3.Tables[0].Rows.Count > 0)
            {
                ...
                else if (Convert.ToByte(fltype) == 2)
                {
    ...
    protected void btnReplyClicked3(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
         ...
         ds = ClPost.Get_Check_Data_Folowers(Convert.ToInt32(userid), frindId, 1);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ClPost.Update_Frnd_Status(Convert.ToInt32(userid), frindId, 0);
            return;

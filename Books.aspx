                           ...
                           <%--         <div class="eventstitle">Like Flims</div>--%>
                                ...
                                <div class="item active">
                	                   <div class="row gutter-10">
											      ...
											      <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b3.png"></a>
                                                   ...
                                                   <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b4.jpg"></a>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b5.jpg"></a>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b6.jpg"></a>
                                ...
                                <div class="item">
                	                <div class="row gutter-10">
											      ...
											      <div class="col-sm-3">
                                                   ...
                                                   <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b8.jpg"></a>
                                                           <h5><a href="#">Arafat Mohsin </a></h5>
                                                            <p class="fonteventtext">Boka Chad<br>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b9.png"></a>
                                                           <h5><a href="#">Pritom feat</a></h5>
                                                            <p class="fonteventtext">Akash Bhora Josna <br>
                                                    ...
                                                    <div class="col-sm-3">
                                                          <a href="#"> <img class="imageeventsbooks" src="img/b1.jpg"></a>
                                                           <h5><a href="#">Shapla Salique </a></h5>
                                                            <p class="fonteventtext">Achen Kothay <br>
                           ...
                           <div class="aboutwraptitle">
				              ...
				              <div class="text-right">
								        <ul class="nav nav-tabs tabmusicwrap">
                                              <li class="menumfollow active"><a data-toggle="tab" href="#15e" aria-expanded="true">Read</a>
					                         </li>
                                            <li class="menumfollow"><a data-toggle="tab" href="#16e" aria-expanded="false">Want to Read</a>
					                         </li>
                    ...
                    <div class="" id="exTab2">	
                       <div class="tab-content tabcontents">
	   		                <div style="" id="15e" class="tab-pane active">
                                   <!--music step slider start-->
                                  <div class="boxproetabevent2">
                         <div class="eventstitle">Read</div>
                            ...
                            <div id="16e" class="tab-pane">
                                      <div class="">
                                  	 <div class="">
                                       <div class="eventstitle">Want To Read</div>
                                  	    <div class="row gutter-10">
